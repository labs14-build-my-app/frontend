  ...
  return (
    <NavigationElements>
      <div className="menu-nav">
        <h2>DevFindr</h2>
        <img
          src={process.env.PUBLIC_URL + "/images/icon_Menu.svg"}
          alt="menu"
        />
      ...
      <nav className="alt-menu-nav">
        <ul>
          ...
          <li>
            <NavLink to="/dev/statements">Statements</NavLink>
          </li>
          <li>
            <NavLink to="/dev/notifications">Notifications</NavLink>
          </li>
          <li>
            <NavLink to="/dev/settings">Settings</NavLink>
          </li>
        </ul>
      </nav>
    </NavigationElements>
