    ...
    <LeftNavigationElements>
      <div className="LeftNav">
        <ul>
          ...
          {/* Home Icon */}
          <NavLink to={user.isDeveloper ? "/dev/home" : "/ent/home"}>
            <li>
              <svg xmlns="http://www.w3.org/2000/svg" width="25.721" height="20.001" viewBox="0 0 25.721 20.001" >
                <defs />
                <path d="M12.5,37.239l-8.232,6.78v7.318a.714.714,0,0,0,.714.714l5-.013a.714.714,0,0,0,.711-.714V47.05a.714.714,0,0,1,.714-.714h2.858a.714.714,0,0,1,.714.714v4.27a.714.714,0,0,0,.714.717l5,.014a.714.714,0,0,0,.714-.714V44.014l-8.23-6.775a.544.544,0,0,0-.683,0Zm13,4.608L21.774,38.77V32.586a.536.536,0,0,0-.536-.536h-2.5a.536.536,0,0,0-.536.536v3.242l-4-3.289a2.143,2.143,0,0,0-2.724,0L.179,41.847a.536.536,0,0,0-.071.755l1.139,1.384A.536.536,0,0,0,2,44.058l10.5-8.65a.544.544,0,0,1,.683,0l10.5,8.65a.536.536,0,0,0,.755-.071L25.583,42.6a.536.536,0,0,0-.076-.756Z" transform="translate(0.015 -32.05)" />
              </svg>
            </li>
          </NavLink>
          ...
          <NavLink to="/dev/find/projects">
            <li>
              <svg xmlns="http://www.w3.org/2000/svg" width="19.996" height="20" viewBox="0 0 19.996 20" >
                <defs />
                <path className="a" d="M19.725,17.291,15.83,13.4a.937.937,0,0,0-.664-.273H14.53a8.12,8.12,0,1,0-1.406,1.406v.637a.937.937,0,0,0,.273.664l3.894,3.894a.934.934,0,0,0,1.324,0l1.105-1.105A.942.942,0,0,0,19.725,17.291Zm-11.6-4.168a5,5,0,1,1,5-5A5,5,0,0,1,8.124,13.124Z" transform="translate(0)" />
              </svg>
            </li>
          </NavLink>
          ...
          <NavLink to="/dev/statements">
            <li>
              <svg xmlns="http://www.w3.org/2000/svg" width="11.248" height="20" viewBox="0 0 11.248 20">
                <defs />
                <path class="a" d="M8.207,9.117,3.988,7.883a1.152,1.152,0,0,1,.324-2.258H6.9a2.384,2.384,0,0,1,1.336.41A.609.609,0,0,0,9,5.957l1.359-1.328a.633.633,0,0,0-.07-.957A5.524,5.524,0,0,0,6.91,2.5V.625A.627.627,0,0,0,6.285,0H5.035A.627.627,0,0,0,4.41.625V2.5h-.1A4.28,4.28,0,0,0,.055,7.172a4.472,4.472,0,0,0,3.273,3.773l4,1.172a1.152,1.152,0,0,1-.324,2.258H4.418a2.384,2.384,0,0,1-1.336-.41.609.609,0,0,0-.762.078L.961,15.371a.633.633,0,0,0,.07.957A5.524,5.524,0,0,0,4.41,17.5v1.875A.627.627,0,0,0,5.035,20h1.25a.627.627,0,0,0,.625-.625V17.492a4.412,4.412,0,0,0,4.129-2.84A4.289,4.289,0,0,0,8.207,9.117Z" transform="translate(-0.035)" />
              </svg>
            </li>
          </NavLink>
