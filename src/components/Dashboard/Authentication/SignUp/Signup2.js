...
const LeftContainer = styled.div`
  ...
  .l-container {
    ...
    .text3 {
      ...
      color: #ffffff;
      opacity: 1;
      background: transparent linear-gradient(86deg, #16075e 0%, #7313b3 100%)
      ...
      <Signup2PageContainer className="page-container">
        <LeftContainer>
          <div className="l-container">
            ...
            <div className="text3">
              This can't be changed later, but you can always make a new
              account.
            </div>
            <div className="buttons">
              <button className="button" onClick={this.handleEnt}>
                Entrepreneur
              </button>
              <button className="button" onClick={this.handleDev}>
                Developer
              </button>
            </div>
          </div>
